<template>
  <div>
   <div>
    <button class="btn btn-default" @click="toAddCustomer()" ><i class="glyphicon glyphicon-plus"></i>&nbsp;添加客户</button>
    ...
    <table class="table table-hover">
          ...
          <tbody>
            <tr v-for="c in customers">
              ...
              <td>{{c.phone}}</td>
              <td>
                <a href="javascript:void(0)" @click="toEditCustomer(c.id)"><i class="glyphicon glyphicon-wrench"></i></a>
                <a href="javascript:void(0)" @click="deleteCustomer(c.id)"><i class="glyphicon glyphicon-trash"></i></a>
  ...
  export default{
    ...
    methods:{
      ...
      toAddCustomer:function(){
      		this.$router.push("/main/addCustomer");
      },
      ...
      deleteCustomer:function(id){
      	  ...
      	  if(confirm("确定删除吗？")){
      	  	$.ajax({
	      			type:"post",
	      			url:"http://localhost:8082/crm/customerController/deleteCustomerById",
	      			data:{
